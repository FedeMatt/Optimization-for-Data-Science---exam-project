...
if __name__ == "__main__":
    ...
    fpred, f, w, mean, t, loss, f_values, inner = IZFW(F, d, w0, L, B, D, r=10, T=100, eps=1e-6)
    print('\n\n')
    # print resume
    print(f'OUTPUT:\n\nF(w_pred) = {fpred}\n\nF(w) = {f}\n\nw = {w}\n\naverage w = {mean}\n\nT = {t}')
    ...
    np.save('../Data/results/function_IZFW_cox_long.npy',f_values)
    np.save('../Data/results/loss_IZFW_cox_long.npy',loss)
    np.save('../Data/results/inner_IZFW_cox_long.npy',inner)
